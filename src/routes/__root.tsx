...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Manrope:wght@300;400;500;600&family=Sora:wght@400;500;600&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <a
        href="#main"
        className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[100] focus:rounded-full focus:bg-navy focus:px-5 focus:py-3 focus:text-sm focus:text-on-dark"
      >
        Skip to content
      </a>
      <Navbar />
